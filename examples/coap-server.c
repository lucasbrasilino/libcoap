...
static void
hnd_get_urand(coap_context_t  *ctx,
	      struct coap_resource_t *resource,
	      const coap_endpoint_t *local_interface UNUSED_PARAM,
	      coap_address_t *peer,
	      coap_pdu_t *request,
...
init_resources(coap_context_t *ctx) {
    ...
    r = coap_resource_init((unsigned char *)"urand", 5, COAP_RESOURCE_FLAGS_NOTIFY_CON);
    coap_register_handler(r, COAP_REQUEST_GET, hnd_get_urand);
    coap_add_resource(ctx, r); 
